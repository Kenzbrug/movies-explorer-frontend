...
function Navigation({ location, clickMenu, handleClickMenu, handleCloseClickMenu, loggedIn }) {
    ...
    return (
        <nav className={`navigation ${clickMenu ? 'navigation__active' : ''}`}>
            ...
            ${location === '/' ? 'navigation__menu-item-close_hidden navigation__menu_hidden'
            ...
            {!loggedIn === true ?
                ...
                location === '/signin' ? ('') :
                    location === '/signup' ? ('') :
                        (<div className={`navigation__links ${clickMenu ? 'navigation__links_active' : ''}`}>
                            <ul className='navigation__lists'>
                                ...
                                <li className='navigation__list'>
                                    <NavLink activeClassName='navigation__page-is-active' onClick={handleCloseClickMenu} className='navigation__savefilms-button' to='/saved-movies'>
                                        Сохранённые фильмы
                                    </NavLink>
                                </li>
                            </ul>
                            <ul className='navigation__lists'>
                                <li className='navigation__list'>
                                    <NavLink activeClassName='navigation__page-is-active' onClick={handleCloseClickMenu} className='navigation__account-button' to='/profile'>
                                        Аккаунт
                                    </NavLink>
                                </li>
                            </ul>
